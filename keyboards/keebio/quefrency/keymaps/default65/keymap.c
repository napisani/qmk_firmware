...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65(
    ...
    HY_ESC,  A_SYM,   S_CTRL,  D_ARROWS,KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    L_SYM,   KC_SCLN, KC_QUOT, KC_ENT,  KC_PGUP,
  ...
  [_LA_SYM] = LAYOUT_65(
    ...
    _______, _______, _______, _______, S(KC_9), KC_QUOT, S(KC_QUOT), S(KC_0), _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, KC_LBRC, S(KC_LBRC), KC_COMM, KC_DOT, S(KC_RBRC), KC_RBRC, _______, _______, _______, _______, _______,
    _______, _______, _______, S(KC_COMM), S(KC_7), _______, S(KC_8), S(KC_DOT), _______, _______, _______, _______, _______, _______,
  ...
  [_LL_SYM] = LAYOUT_65(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, KC_0,    S(KC_6), S(KC_4), S(KC_EQL), S(KC_GRV), _______, KC_MINS, S(KC_MINS), _______, _______, _______, _______, _______, _______,
    _______, S(KC_2), _______, _______, S(KC_SCLN), KC_SLSH, S(KC_SLSH), KC_EQL, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, KC_BSLS, S(KC_1),   _______, S(KC_5),   S(KC_BSLS), _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_LS_CTRL] = LAYOUT_65(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, LCTL(KC_H), LCTL(KC_J), LCTL(KC_K), LCTL(KC_L), _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______
  )
};
